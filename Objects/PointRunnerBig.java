...
public class Main {
    ...
    Point p0 = new Point();
		...
		System.out.println("p1 " + p1 + " quadrant = " + p1.checkQuad());
		System.out.println("p2 " + p2 + " quadrant = " + p2.checkQuad());
		System.out.println("p3 " + p3 + " quadrant = " + p3.checkQuad());
		System.out.println("p4 " + p4 + " quadrant = " + p4.checkQuad());
		System.out.println("p0 " + p0 + " quadrant = " + p0.checkQuad());
		System.out.println();
