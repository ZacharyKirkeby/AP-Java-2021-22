...
public class Main {
    ...
    Dice die2 = new Dice();
      ...
      if(die1.isEqual(die2) == 1){
        snakeEyes++;
      }else if(die1.isEqual(die2) == 2){
        twos++;
      }else if(die1.isEqual(die2) == 3){
        threes++;
      }else if(die1.isEqual(die2) == 4){
        fours++;
      }else if(die1.isEqual(die2) == 5){
        fives++;
      }else if(die1.isEqual(die2) == 6){
        sixes++;
      }
      count++;
      }
